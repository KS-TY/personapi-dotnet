    ...
    public partial class UpdateDeleteCascade : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__persona__3213666D75604E2B", x => x.cc);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__profesio__3213E83FB53E5714", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__telefono__DF908D65818B78D4", x => x.num);
                    table.ForeignKey(
                        name: "FK__telefono__duenio__3C69FB99",
                        column: x => x.duenio,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__estudios__FB3F71A6DC32A91E", x => new { x.id_prof, x.cc_per });
                    table.ForeignKey(
                        name: "FK__estudios__cc_per__38996AB5",
                        column: x => x.cc_per,
                        principalTable: "persona",
                        principalColumn: "cc",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__estudios__id_pro__398D8EEE",
                        column: x => x.id_prof,
